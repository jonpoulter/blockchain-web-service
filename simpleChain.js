...
class Blockchain{
  ...
  async addBlock(newBlock) {
        ...
        const b = await this.addLevelDBData(newBlock.height, JSON.stringify(newBlock).toString());
        console.log(`Added block to chain with details ${b}`); 
        return b; 
  }
  ...
  getBlockHeight(){
   ...
   async getBlocks() {
    ...
    async addLevelDBData(key,value) {
      ...
      console.log(`Block ${key} persisted`);
    ...
    //Uses callbacks for db.get() call which is wrapped in a Promise
    getLevelDBData(key){
